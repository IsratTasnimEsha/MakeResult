...
class SixthPage(Screen):
    def __init__(self, **kwargs):
        ...
        for i in range(18):
            ...
            self.r_input.append(Button(text=str(i+88), background_color=(0, 128/255, 0, .7)))
        ...
        for i in range(18*14):
            ...
            if i%14==13:
                self.t_input.append(TextInput(hint_text= 'Roll:'+str(int(i/14+88)), background_color=(192/255, 192/255, 192/255, .5)))
            
            else:

                if i%2==0:
                    self.t_input.append(TextInput(hint_text= 'Roll:'+str(int(i/14+88)), background_color=(0, 128/255, 128/255, .8)))    

                else:
                    self.t_input.append(TextInput(hint_text= 'Roll:'+str(int(i/14+88)), background_color=(1, 1, 1, 1)))
        ...
        self.input=Label(text='Page-6', size_hint_x=.2, bold=True)
        self.grid.add_widget(self.input)
