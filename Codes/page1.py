...
class FirstPage(Screen):
    def __init__(self, **kwargs):
        ...
        self.ins_input=TextInput(hint_text='Institution Name', size_hint=(1, .13), font_size='60sp', halign='center', foreground_color=(0, 128/255,128/255), background_color=(0, 0, 0))
        self.box.add_widget(self.ins_input)

        #.........................................................................................1: Part 2.........................................................................................#

        self.b_grid=GridLayout(rows=1,  size_hint=(1, .08), padding=7, spacing=170)

        #.........................................................................................1: Part 2.1.........................................................................................#

        self.grid=GridLayout(cols=2)

        self.input=Button(text='Exam Name: ')
        self.grid.add_widget(self.input)

        self.ex_input=TextInput()
        self.grid.add_widget(self.ex_input)
        ...
        for i in range(15):
            ...
            self.r_input.append(Button(text=str(i+1), background_color=(0, 128/255, 0, .7)))
        ...
        self.grid=GridLayout(rows=1,  size_hint=(1, .08), padding=10)
        ...
        self.input=Label(text='Page-1', size_hint_x=.2, bold=True)
        self.grid.add_widget(self.input)
        ...
        self.input=Button(text='Next', size_hint_x=.2, on_press=self.update)
    ...
    def update(self, *args):
        ...
        for i in range(12):
            ...
            self.manager.get_screen(self.pages[i]).p_input.text=self.p_input.text

            self.manager.get_screen(self.pages[i]).c_input.text=self.c_input.text
            self.manager.get_screen(self.pages[i]).sec_input.text=self.sec_input.text
            self.manager.get_screen(self.pages[i]).sub_input.text=self.sub_input.text

            for j in range(14):
                
                self.manager.get_screen(self.pages[i]).total_input[j].text=self.total_input[j].text
                self.manager.get_screen(self.pages[i]).st_input[j].text=self.st_input[j].text